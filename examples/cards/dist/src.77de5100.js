...
(function (CardStatus) {
  CardStatus[CardStatus["Hand"] = 0] = "Hand";
  CardStatus[CardStatus["Deck"] = 1] = "Deck";
  CardStatus[CardStatus["Field"] = 2] = "Field";
  CardStatus[CardStatus["Graveyard"] = 3] = "Graveyard";
  CardStatus[CardStatus["Dust"] = 4] = "Dust";
...
;
},{}],"../node_modules/sillyname/index.js":[function(require,module,exports) {
...
},{}],"store.ts":[function(require,module,exports) {
"use strict";
...
var unistore_1 = __importDefault(require("unistore"));

var types_1 = require("./types"); //@ts-ignore
...
var getCardType = function getCardType() {
  var types = [types_1.CardType.Unit, types_1.CardType.Spell];
  return types[Math.floor(Math.random() * types.length)];
};

var getCard = function getCard(playerId) {
  return {
    id: getCardId(),
    playerId: playerId,
    type: getCardType(),
    name: sillyname_1.default(),
    cost: Math.ceil(Math.random() * 9),
    artId: Math.ceil(Math.random() * 32)
  };
};

var getPlayerState = function getPlayerState(playerId) {
  return {
    inDeck: [getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId), getCard(playerId)],
    inHand: [],
    inPlay: [],
    mana: 1,
    manaMax: 1
...
var store = unistore_1.default(state);
exports.default = store;
},{"unistore":"../node_modules/unistore/dist/unistore.es.js","./types":"types.ts","sillyname":"../node_modules/sillyname/index.js"}],"actions.ts":[function(require,module,exports) {
"use strict";
...
exports.playCard = function (playerId, cardId) {
  var state = store_1.default.getState();
  var playerState = state.players[playerId];
  var inHand = playerState.inHand,
      inPlay = playerState.inPlay;
  var idx = inHand.findIndex(function (card) {
...
exports.endTurn = function () {
  ...
  var nextPlayerId = currentPlayerId === 1 ? 2 : 1;
  var nextPlayerState = state.players[nextPlayerId];
  var turnIndex = state.turnIndex + 1;
  store_1.default.setState({
    turnIndex: turnIndex,
    currentPlayerId: nextPlayerId,
    players: __assign(__assign({}, state.players), (_a = {}, _a[nextPlayerId] = __assign(__assign({}, nextPlayerState), {
      mana: turnIndex,
      manaMax: turnIndex
    }), _a))
  });
};
},{"./store":"store.ts"}],"../../../src/ecs/Component.ts":[function(require,module,exports) {
"use strict";
...
},{"./Component":"../../../src/ecs/Component.ts","./Entity":"../../../src/ecs/Entity.ts","./Archetype":"../../../src/ecs/Archetype.ts","./EntityManager":"../../../src/ecs/EntityManager.ts","./System":"../../../src/ecs/System.ts","./World":"../../../src/ecs/World.ts"}],"archetypes/CardsArchetype.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(CardsArchetype, _super);

  function CardsArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [_this.include('card')];
    return _this;
  }

  return CardsArchetype;
}(ecs_1.Archetype);

exports.default = CardsArchetype;
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"archetypes/PlayerCardsArchetype.ts":[function(require,module,exports) {
"use strict";
...
var PlayerCardsArchetype =
/** @class */
function (_super) {
  __extends(PlayerCardsArchetype, _super);

  function PlayerCardsArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [_this.include('card'), _this.include('player'), function (entity) {
      return entity.components.player.value.id === 1;
    }];
    return _this;
  }

  return PlayerCardsArchetype;
}(ecs_1.Archetype);

exports.default = PlayerCardsArchetype;
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"archetypes/OpponentCardsArchetype.ts":[function(require,module,exports) {
"use strict";
...
var OpponentCardsArchetype =
/** @class */
function (_super) {
  __extends(OpponentCardsArchetype, _super);

  function OpponentCardsArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [_this.include('card'), _this.include('player'), function (entity) {
      return entity.components.player.value.id === 0;
    }];
    return _this;
  }

  return OpponentCardsArchetype;
}(ecs_1.Archetype);

exports.default = OpponentCardsArchetype;
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"archetypes/DeckCardsArchetype.ts":[function(require,module,exports) {
"use strict";
...
var DeckCardsArchetype =
/** @class */
function (_super) {
  __extends(DeckCardsArchetype, _super);

  function DeckCardsArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [_this.include('card'), function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Deck;
    }];
    return _this;
  }

  return DeckCardsArchetype;
}(ecs_1.Archetype);

exports.default = DeckCardsArchetype;
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../types":"types.ts"}],"archetypes/HandCardsArchetype.ts":[function(require,module,exports) {
"use strict";
...
var HandCardsArchetype =
/** @class */
function (_super) {
  __extends(HandCardsArchetype, _super);

  function HandCardsArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [_this.include('card'), function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Hand;
    }];
    return _this;
  }

  return HandCardsArchetype;
}(ecs_1.Archetype);

exports.default = HandCardsArchetype;
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../types":"types.ts"}],"archetypes/PlayerDeckCardsArchetype.ts":[function(require,module,exports) {
"use strict";
...
var PlayerDeckCardsArchetype =
/** @class */
function (_super) {
  __extends(PlayerDeckCardsArchetype, _super);

  function PlayerDeckCardsArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [function (entity) {
      return !!entity.components.player.value && entity.components.player.value.id === 1 && !!entity.components.card && entity.components.card.value.status === types_1.CardStatus.Deck;
    }];
    return _this;
  }

  return PlayerDeckCardsArchetype;
}(ecs_1.Archetype);

exports.default = PlayerDeckCardsArchetype;
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../types":"types.ts"}],"archetypes/RenderableArchetype.ts":[function(require,module,exports) {
"use strict";
...
var RenderableArchetype =
/** @class */
function (_super) {
  __extends(RenderableArchetype, _super);

  function RenderableArchetype() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.filters = [_this.include('dom')];
    return _this;
  }

  return RenderableArchetype;
}(ecs_1.Archetype);

exports.default = RenderableArchetype;
...
var CardsArchetype_1 = require("./CardsArchetype");

exports.CardsArchetype = CardsArchetype_1.default;

var PlayerCardsArchetype_1 = require("./PlayerCardsArchetype");

exports.PlayerCardsArchetype = PlayerCardsArchetype_1.default;

var OpponentCardsArchetype_1 = require("./OpponentCardsArchetype");

exports.OpponentCardsArchetype = OpponentCardsArchetype_1.default;

var DeckCardsArchetype_1 = require("./DeckCardsArchetype");

exports.DeckCardsArchetype = DeckCardsArchetype_1.default;

var HandCardsArchetype_1 = require("./HandCardsArchetype");

exports.HandCardsArchetype = HandCardsArchetype_1.default;

var PlayerDeckCardsArchetype_1 = require("./PlayerDeckCardsArchetype");

exports.PlayerDeckCardsArchetype = PlayerDeckCardsArchetype_1.default;

var RenderableArchetype_1 = require("./RenderableArchetype");

exports.RenderableArchetype = RenderableArchetype_1.default;
},{"./CardsArchetype":"archetypes/CardsArchetype.ts","./PlayerCardsArchetype":"archetypes/PlayerCardsArchetype.ts","./OpponentCardsArchetype":"archetypes/OpponentCardsArchetype.ts","./DeckCardsArchetype":"archetypes/DeckCardsArchetype.ts","./HandCardsArchetype":"archetypes/HandCardsArchetype.ts","./PlayerDeckCardsArchetype":"archetypes/PlayerDeckCardsArchetype.ts","./RenderableArchetype":"archetypes/RenderableArchetype.ts"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"systems/RenderSystem.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  RenderSystem.prototype.update = function (manager, dt) {
    var entities = manager.getArchetype(archetypes_1.RenderableArchetype).entities;
    entities.forEach(function (entity) {
      var _a = entity.getComponentValue('dom'),
          element = _a.element,
          className = _a.className;

      var width = entity.getComponentValue('width');
      var height = entity.getComponentValue('height');
      var boxShadow = entity.getComponentValue('boxShadow');
      var position = entity.getComponentValue('position');
      var borderRadius = entity.getComponentValue('borderRadius');
      var rotation = entity.getComponentValue('rotation');
      var card = entity.getComponentValue('card');
      var material = entity.getComponentValue('material');
      var player = entity.getComponentValue('player');
      var isPlayer = player.id === 1;
      var showFace = isPlayer && card.status !== types_1.CardStatus.Deck || card.status === types_1.CardStatus.Field;
      var $element = jquery_1.default(element);
      var viewport = jquery_1.default('body > main');
      $element.attr('data-id', entity.id);

      if (document.body.contains(element)) {//
      } else {
        if (card) {
          $element.addClass(className).html("<div class=\"face\">\n                <div class=\"title\">" + card.name + "</div>\n                <div class=\"cost\">" + card.cost + "</div>\n              </div>\n              <div class=\"back\"></div>").children();
        }
      ...
      if (position) {
        transforms.push("translate3d(" + position.x + "px, " + position.y + "px, " + position.z + "px)");
        $element.css('z-index', Math.round(position.z));
      }

      if (rotation) {
        transforms.push("rotateZ(" + rotation.z + "deg) rotateX(" + rotation.x + "deg) rotateY(" + rotation.y + "deg)");
      }
      ...
      if (boxShadow) {
        $element.css('box-shadow', boxShadow.hOffset + "px " + boxShadow.vOffset + "px " + boxShadow.blur + "px " + boxShadow.spread + "px rgba(" + boxShadow.color.r + ", " + boxShadow.color.g + ", " + boxShadow.color.b + ", " + boxShadow.color.a + ")");
      }
    });
  };
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../archetypes":"archetypes/index.ts","jquery":"../node_modules/jquery/dist/jquery.js","../types":"types.ts"}],"components/PositionComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/RotationComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/HoverComponent.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(HoverComponent, _super);
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/PlayerComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/CardComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/DomComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/ColorComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/WidthComponent.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(WidthComponent, _super);
...
exports.default = WidthComponent;
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/HeightComponent.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(HeightComponent, _super);
...
exports.default = HeightComponent;
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/BoxShadowComponent.ts":[function(require,module,exports) {
"use strict";
...
var BoxShadowComponent =
/** @class */
function (_super) {
  __extends(BoxShadowComponent, _super);
...
exports.default = BoxShadowComponent;
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/BorderRadiusComponent.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(BorderRadiusComponent, _super);
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/MaterialComponent.ts":[function(require,module,exports) {
"use strict";
...
},{"../../../../src/ecs":"../../../src/ecs/index.ts"}],"components/OrderComponent.ts":[function(require,module,exports) {
"use strict";
...
var RotationComponent_1 = __importDefault(require("./RotationComponent"));

exports.RotationComponent = RotationComponent_1.default;

var HoverComponent_1 = __importDefault(require("./HoverComponent"));

exports.HoverComponent = HoverComponent_1.default;

var PlayerComponent_1 = __importDefault(require("./PlayerComponent"));

exports.PlayerComponent = PlayerComponent_1.default;

var CardComponent_1 = __importDefault(require("./CardComponent"));

exports.CardComponent = CardComponent_1.default;

var DomComponent_1 = __importDefault(require("./DomComponent"));

exports.DomComponent = DomComponent_1.default;

var ColorComponent_1 = __importDefault(require("./ColorComponent"));

exports.ColorComponent = ColorComponent_1.default;

var WidthComponent_1 = __importDefault(require("./WidthComponent"));

exports.WidthComponent = WidthComponent_1.default;

var HeightComponent_1 = __importDefault(require("./HeightComponent"));

exports.HeightComponent = HeightComponent_1.default;

var BoxShadowComponent_1 = __importDefault(require("./BoxShadowComponent"));

exports.BoxShadowComponent = BoxShadowComponent_1.default;

var BorderRadiusComponent_1 = __importDefault(require("./BorderRadiusComponent"));

exports.BorderRadiusComponent = BorderRadiusComponent_1.default;

var MaterialComponent_1 = __importDefault(require("./MaterialComponent"));

exports.MaterialComponent = MaterialComponent_1.default;

var OrderComponent_1 = __importDefault(require("./OrderComponent"));

exports.OrderComponent = OrderComponent_1.default;
},{"./PositionComponent":"components/PositionComponent.ts","./RotationComponent":"components/RotationComponent.ts","./HoverComponent":"components/HoverComponent.ts","./PlayerComponent":"components/PlayerComponent.ts","./CardComponent":"components/CardComponent.ts","./DomComponent":"components/DomComponent.ts","./ColorComponent":"components/ColorComponent.ts","./WidthComponent":"components/WidthComponent.ts","./HeightComponent":"components/HeightComponent.ts","./BoxShadowComponent":"components/BoxShadowComponent.ts","./BorderRadiusComponent":"components/BorderRadiusComponent.ts","./MaterialComponent":"components/MaterialComponent.ts","./OrderComponent":"components/OrderComponent.ts"}],"images/1.jpg":[function(require,module,exports) {
module.exports = "/1.106c6bd6.jpg";
},{}],"images/10.jpg":[function(require,module,exports) {
module.exports = "/10.dd8e1232.jpg";
},{}],"images/11.jpg":[function(require,module,exports) {
module.exports = "/11.86e7d40e.jpg";
},{}],"images/12.jpg":[function(require,module,exports) {
module.exports = "/12.144063dc.jpg";
},{}],"images/13.jpg":[function(require,module,exports) {
module.exports = "/13.23fa51b6.jpg";
},{}],"images/14.jpg":[function(require,module,exports) {
module.exports = "/14.425ab510.jpg";
},{}],"images/15.jpg":[function(require,module,exports) {
module.exports = "/15.52943bd2.jpg";
},{}],"images/16.jpg":[function(require,module,exports) {
module.exports = "/16.081fb133.jpg";
},{}],"images/17.jpg":[function(require,module,exports) {
module.exports = "/17.7cccce4d.jpg";
},{}],"images/18.jpg":[function(require,module,exports) {
module.exports = "/18.6bd3ce5f.jpg";
},{}],"images/2.jpg":[function(require,module,exports) {
module.exports = "/2.adddeb7c.jpg";
},{}],"images/19.jpg":[function(require,module,exports) {
module.exports = "/19.4e1956fd.jpg";
},{}],"images/20.jpg":[function(require,module,exports) {
module.exports = "/20.5de10e8a.jpg";
},{}],"images/21.jpg":[function(require,module,exports) {
module.exports = "/21.83e97601.jpg";
},{}],"images/22.jpg":[function(require,module,exports) {
module.exports = "/22.7f5b4566.jpg";
},{}],"images/23.jpg":[function(require,module,exports) {
module.exports = "/23.4aaaaf70.jpg";
},{}],"images/24.jpg":[function(require,module,exports) {
module.exports = "/24.a458acac.jpg";
},{}],"images/25.jpg":[function(require,module,exports) {
module.exports = "/25.43e83562.jpg";
},{}],"images/26.jpg":[function(require,module,exports) {
module.exports = "/26.37bc013a.jpg";
},{}],"images/27.jpg":[function(require,module,exports) {
module.exports = "/27.5930fcb8.jpg";
},{}],"images/28.jpg":[function(require,module,exports) {
module.exports = "/28.06855e1e.jpg";
},{}],"images/29.jpg":[function(require,module,exports) {
module.exports = "/29.1abf700f.jpg";
},{}],"images/3.jpg":[function(require,module,exports) {
module.exports = "/3.993a564c.jpg";
},{}],"images/30.jpg":[function(require,module,exports) {
module.exports = "/30.df9b8c32.jpg";
},{}],"images/31.jpg":[function(require,module,exports) {
module.exports = "/31.57ca6ceb.jpg";
},{}],"images/32.jpg":[function(require,module,exports) {
module.exports = "/32.7b212806.jpg";
...
},{}],"images/8.jpg":[function(require,module,exports) {
module.exports = "/8.4d0a6fce.jpg";
},{}],"images/9.jpg":[function(require,module,exports) {
module.exports = "/9.da115fa2.jpg";
},{}],"images/back.jpg":[function(require,module,exports) {
module.exports = "/back.c299382f.jpg";
...
},{"./1.jpg":"images/1.jpg","./10.jpg":"images/10.jpg","./11.jpg":"images/11.jpg","./12.jpg":"images/12.jpg","./13.jpg":"images/13.jpg","./14.jpg":"images/14.jpg","./15.jpg":"images/15.jpg","./16.jpg":"images/16.jpg","./17.jpg":"images/17.jpg","./18.jpg":"images/18.jpg","./2.jpg":"images/2.jpg","./19.jpg":"images/19.jpg","./20.jpg":"images/20.jpg","./21.jpg":"images/21.jpg","./22.jpg":"images/22.jpg","./23.jpg":"images/23.jpg","./24.jpg":"images/24.jpg","./25.jpg":"images/25.jpg","./26.jpg":"images/26.jpg","./27.jpg":"images/27.jpg","./28.jpg":"images/28.jpg","./29.jpg":"images/29.jpg","./3.jpg":"images/3.jpg","./30.jpg":"images/30.jpg","./31.jpg":"images/31.jpg","./32.jpg":"images/32.jpg","./4.jpg":"images/4.jpg","./5.jpg":"images/5.jpg","./6.jpg":"images/6.jpg","./7.jpg":"images/7.jpg","./8.jpg":"images/8.jpg","./9.jpg":"images/9.jpg","./back.jpg":"images/back.jpg"}],"assemblages/CardAssemblage.ts":[function(require,module,exports) {
"use strict";
...
var jquery_1 = __importDefault(require("jquery")); // @ts-ignore


var __jpg_1 = __importDefault(require("../images/*.jpg"));

var CardAssemblage = function CardAssemblage(card, status) {
  var element = jquery_1.default('<div/>').get(0);
  var isPlayer = card.playerId === 1;
  return [new components_1.CardComponent({
    id: card.id,
    cardType: card.type,
    name: card.name,
    cost: card.cost,
    status: status
  }), new components_1.MaterialComponent({
    imageSrc: __jpg_1.default[card.artId]
  }), new components_1.PlayerComponent({
    id: card.playerId
  }), new components_1.WidthComponent(125), new components_1.HeightComponent(175), new components_1.HoverComponent(false), new components_1.OrderComponent(0), new components_1.PositionComponent({
    x: 0,
    y: 0,
    z: 0
  }), new components_1.RotationComponent({
    x: 0,
    y: 180,
    z: Math.random() * 4 - 2 + 180
  }), new components_1.DomComponent({
    className: 'card',
    element: element
  }), new components_1.BoxShadowComponent({
    hOffset: 0,
    vOffset: 2,
    blur: 6,
    spread: 2,
    color: new components_1.ColorComponent({
      r: 0,
      g: 0,
      b: 0,
      a: 0.3
    }).value
  }), new components_1.BorderRadiusComponent(6)];
};

exports.default = CardAssemblage;
},{"../components":"components/index.ts","jquery":"../node_modules/jquery/dist/jquery.js","../images/*.jpg":"images/*.jpg"}],"systems/DeckSystem.ts":[function(require,module,exports) {
"use strict";
...
var updateDeckPosition = function updateDeckPosition(playerId, position, idx) {
...
/** @class */
function (_super) {
  __extends(DeckSystem, _super);

  function DeckSystem() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  DeckSystem.prototype.update = function (manager, dt) {
    var playerCards = manager.getArchetype(archetypes_1.PlayerCardsArchetype).entities;
    var opponentCards = manager.getArchetype(archetypes_1.OpponentCardsArchetype).entities;
    playerCards.filter(function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Deck;
    }).forEach(function (entity, idx) {
      var position = entity.getComponentValue('position');
      var player = entity.getComponentValue('player');
      updateDeckPosition(player.id, position, idx);
    });
    opponentCards.filter(function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Deck;
    }).forEach(function (entity, idx) {
      var position = entity.getComponentValue('position');
      var player = entity.getComponentValue('player');
...
exports.default = DeckSystem;
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../archetypes":"archetypes/index.ts","../types":"types.ts"}],"systems/HandSystem.ts":[function(require,module,exports) {
"use strict";
...
var lerp = function lerp(a, b, dt) {
  return a + dt * (b - a);
};

var cardPositionX = function cardPositionX(index, step, cardCount, isHovering, hoveringIdx) {
  var x = -((cardCount - 1) * step) / 2 + index * step;

  if (isHovering) {
    var half = (cardCount - 1) / 2;
    var hoveredMoved = Math.min(1, Math.max(hoveringIdx - half, -1)) * 20;
...
var cardPositionY = function cardPositionY(index, step, cardCount, isHovering, hoveringIdx) {
  var mid = Math.ceil(cardCount / 2);
  var i = index - mid;
  var s = step;
  var y;
...
var cardPositionZ = function cardPositionZ(index, order, step, isHovering, hoveringIdx) {
  if (isHovering && hoveringIdx === index) {
    return index + step;
  } else {
    return order;
...
var cardRotation = function cardRotation(index, isPlayer, degreesRot, cardCount) {
  var mid = Math.floor(cardCount / 2);
  return (index - mid) * degreesRot;
};

var updateCardPosition = function updateCardPosition(entity, idx, cardCount, isHovering, hoveringIdx) {
  var position = entity.getComponentValue('position');
  var rotation = entity.getComponentValue('rotation');
  var player = entity.getComponentValue('player');
  var order = entity.getComponentValue('order');
  var isPlayer = player.id === 1;
  var xStep = 40;
  var yStep = 5;
  var rStep = 4;
  var zStep = 200;
  var x = cardPositionX(idx, xStep, cardCount, isHovering, hoveringIdx);
  var y = cardPositionY(idx, isPlayer ? -yStep : yStep, cardCount, isHovering, hoveringIdx) + (isPlayer ? window.innerHeight - 225 : 50);
  var rotY = isPlayer ? 0 : 180;
  var rotZ = cardRotation(idx, isPlayer, isPlayer ? rStep : -rStep, cardCount);
  var dt = 0.16 / 2;
  var z = order; // cardPositionZ(idx, order, zStep, isHovering, hoveringIdx)
  ...
  if (Math.abs(position.x - x) > 0.1 || Math.abs(position.y - y) > 0.1 // Math.abs(position.z - z) > 0.1
      ...
      position.y = lerp(position.y, y, dt); // position.z = lerp(position.z, z, dt)
    }
...
/** @class */
function (_super) {
  __extends(HandSystem, _super);

  function HandSystem() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  HandSystem.prototype.update = function (manager, dt) {
    var playerCards = manager.getArchetype(archetypes_1.PlayerCardsArchetype).entities;
    var opponentCards = manager.getArchetype(archetypes_1.OpponentCardsArchetype).entities;
    playerCards = playerCards.filter(function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Hand;
    }).sort(function (a, b) {
      return a.components.order.value - b.components.order.value;
    });
    opponentCards = opponentCards.filter(function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Hand;
    });
    var isHoveringPlayerCards = playerCards.some(function (entity) {
      return entity.components.hover.value;
    });
    var isHoveringOpponentCards = opponentCards.some(function (entity) {
      return entity.components.hover.value;
    });
    var playerHoveringIdx = playerCards.findIndex(function (entity) {
      return entity.components.hover.value;
    });
    var opponentHoveringIdx = opponentCards.findIndex(function (entity) {
      return entity.components.hover.value;
    });
    playerCards.forEach(function (entity, idx) {
      updateCardPosition(entity, idx, playerCards.length, isHoveringPlayerCards, playerHoveringIdx);
    });
    opponentCards.forEach(function (entity, idx) {
      updateCardPosition(entity, idx, opponentCards.length, isHoveringOpponentCards, opponentHoveringIdx);
    });
  };
...
exports.default = HandSystem;
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../archetypes":"archetypes/index.ts","../types":"types.ts"}],"systems/FieldSystem.ts":[function(require,module,exports) {
"use strict";
...
var cardRotation = function cardRotation(index, degreesRot, cardCount) {
  var mid = Math.floor(cardCount / 2);
  return (index - mid) * degreesRot;
};
...
var updateCardPosition = function updateCardPosition(entity, idx, cardCount, isHovering, hoveringIdx) {
  ...
  var yStep = 20;
  var rStep = 4;
  var x = window.innerWidth / 2 - cardCount / 2 * xStep + xStep * idx;
  var y = window.innerHeight / 2 + (isPlayer ? 10 : -180);
  var dt = 0.16;
  var rotZ = 0;
  var rotY = 0;
  var z = -25;
...
/** @class */
function (_super) {
  __extends(FieldSystem, _super);

  function FieldSystem() {
    return _super !== null && _super.apply(this, arguments) || this;
  }

  FieldSystem.prototype.update = function (manager, dt) {
    var playerCards = manager.getArchetype(archetypes_1.PlayerCardsArchetype).entities;
    var opponentCards = manager.getArchetype(archetypes_1.OpponentCardsArchetype).entities;
    playerCards = playerCards.filter(function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Field;
    });
    opponentCards = opponentCards.filter(function (entity) {
      return entity.components.card.value.status === types_1.CardStatus.Field;
    });
...
exports.default = FieldSystem;
},{"../../../../src/ecs":"../../../src/ecs/index.ts","../archetypes":"archetypes/index.ts","../types":"types.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var CardAssemblage_1 = __importDefault(require("./assemblages/CardAssemblage"));

var DeckSystem_1 = __importDefault(require("./systems/DeckSystem"));

var HandSystem_1 = __importDefault(require("./systems/HandSystem"));

var jquery_1 = __importDefault(require("jquery"));

var FieldSystem_1 = __importDefault(require("./systems/FieldSystem"));

var stats = new stats_js_1.default();
var world = new ecs_1.World();
world.addArchetype(archetypes_1.RenderableArchetype);
world.addArchetype(archetypes_1.CardsArchetype);
world.addArchetype(archetypes_1.PlayerCardsArchetype);
world.addArchetype(archetypes_1.OpponentCardsArchetype);
world.addSystem(new RenderSystem_1.default());
world.addSystem(new DeckSystem_1.default());
world.addSystem(new HandSystem_1.default());
world.addSystem(new FieldSystem_1.default());
console.log(world);
var cards = new Map();

var updateCardEntity = function updateCardEntity(card, status, index) {
  if (!cards.has(card.id)) {
    var entity = world.createEntity(CardAssemblage_1.default(card, status));
    cards.set(card.id, entity);
  } else {
    var entity = cards.get(card.id);
...
var syncState = function syncState(state) {
  state.players.forEach(function (player, playerId) {
    player.inDeck.forEach(function (card, idx) {
      updateCardEntity(card, types_1.CardStatus.Deck, idx);
    });
    player.inHand.forEach(function (card, idx) {
      updateCardEntity(card, types_1.CardStatus.Hand, idx);
    });
    player.inPlay.forEach(function (card, idx) {
      updateCardEntity(card, types_1.CardStatus.Field, idx);
    });
  });
};

store_1.default.subscribe(function (state) {
...
window.onkeydown = function (ev) {
  ...
  switch (key) {
    case 68:
      ...
      actions_1.drawCard(1);
      break;
  }
};

jquery_1.default('body').mousemove(function (ev) {
  var target = jquery_1.default(ev.target).closest('.card');
  var id = Number(target.data('id'));
  world.manager.entities.forEach(function (entity) {
  ...
  if (id) {
    var entity = world.manager.getEntity(id);

    if (entity && entity.hasComponent('hover')) {
      var status = entity.components.card.value.status;

      if (status !== types_1.CardStatus.Deck) {
        entity.setComponentValue('hover', true);
      }
    }
  }
});
jquery_1.default('body').on('click', '.card', function (ev) {
  var target = jquery_1.default(ev.target).closest('.card');
  var id = Number(target.data('id'));
  ...
  if (id) {
    ...
    if (entity) {
      ...
      switch (status) {
        case types_1.CardStatus.Deck:
          actions_1.drawCard(entity.components.player.value.id);
          break;

        case types_1.CardStatus.Hand:
          actions_1.playCard(entity.components.player.value.id, entity.components.card.value.id);
          break;
      }
    }
  }
...
var stagger = function stagger(fns, timeout) {
  setTimeout(function () {
    if (fns.length) {
      fns.shift()();
      stagger(fns, timeout);
...
var init = function init() {
  ...
  syncState(store_1.default.getState()); // Start loop

  requestAnimationFrame(loop);
  stagger([function () {
    return actions_1.drawCard(0);
  }, function () {
    return actions_1.drawCard(0);
  }, function () {
    return actions_1.drawCard(0);
...
init();
},{"stats.js":"../node_modules/stats.js/build/stats.min.js","./types":"types.ts","./store":"store.ts","./actions":"actions.ts","../../../src/ecs":"../../../src/ecs/index.ts","./systems/RenderSystem":"systems/RenderSystem.ts","./archetypes":"archetypes/index.ts","./assemblages/CardAssemblage":"assemblages/CardAssemblage.ts","./systems/DeckSystem":"systems/DeckSystem.ts","./systems/HandSystem":"systems/HandSystem.ts","jquery":"../node_modules/jquery/dist/jquery.js","./systems/FieldSystem":"systems/FieldSystem.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
